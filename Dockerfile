...
# Install the Agent
ADD https://1268-34269086-gh.circle-artifacts.com/0/home/ubuntu/docker-dd-agent-build-deb-x64/pkg/datadog-agent_5.9.0.git.8.5e2d2e3-1_amd64.deb /
RUN dpkg -i /datadog-agent_5.9.0.git.8.5e2d2e3-1_amd64.deb && rm /datadog-agent_5.9.0.git.8.5e2d2e3-1_amd64.deb
